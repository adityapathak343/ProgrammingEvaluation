 ...
 * ID Number: 2023A7PS0646P
 * Name: SAMARTH KOTHARI 
 * Lab Number: 6013
 * System Number: 27
 ***********************************************************/
...
class CricketDataHandler {
	...
	public List<Player> readPlayersFromFile(String fileName) throws IOException {
		 	 ...
		 	 try{
		 		 inputStream = new Scanner (new FileInputStream("inputCricketData.csv"));
		 	 }
		 	 ...
		 	 String playernames = inputStream.nextLine();
		 	 System.out.println("The names of players are:");
		 	 System.out.println(playernames);
		 	 inputStream.close();
		 	 
		 	 return null;
		 	 
		 	String playerdetails =(toString());
	...
	public void writePlayersToFile(String fileName, List<Player> players)
		...
		outStream.println("PlayerName, Role, RunScored, WicketsTaken, TeamName");
		outStream.close();
	...
	public void updatePlayerStats(List<Player> players, String playerName,
		...
		while (litr.hasNext())
		{
			Player players1 = (Player)litr.next();
			Object element;
			if (element.getplayerName().equals(this.getPlayerName()))
			{
				element.setrunsScored(this.getrunsScored + 4);
			}
		}
		Nameofplayer = getPlayerName();
		PlayerName p = updatePlayerStats.find(Nameofplayer);
		if (p != this.getplayerName)
		{
