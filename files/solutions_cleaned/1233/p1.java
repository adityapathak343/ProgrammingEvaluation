...
class CricketDataHandler {
	...
	public List<Player> readPlayersFromFile(String fileName) throws IOException {
		...
		try
		{
			outStream=new PrintWriter(new FileOutputStream("C:\Users\user\Desktop\2023A7PS0637P\SS_24_25_CBT"));
			inputStream=new Scanner(new FileInputStream("C:\Users\user\Desktop\2023A7PS0637P\SS_24_25_CBT"));
		}
		...
		outStream.println("Shivansh"+"all rounder"+"70"+"24"+"india");
    ...
    public void writePlayersToFile(String fileName, List<Player> players) throws IOException {
    	...
    	try
		{
			outStream=new PrintWriter(new FileOutputStream("C:\Users\user\Desktop\2023A7PS0637P\SS_24_25_CBT",true));
		}
    	catch(FileNotFoundException e)
		{
			System.out.println("FILE NOT FOUND");
    	...
    	outStream.println("Jasprit Bumrah Adam Zampa Pat Cummins Jofra Archer Mitchell Starc Chris Woakes Ravindra Jadeja Joe Root Steve Smith KL Rahul Sam Curran Rohit Sharma Virat Kohli David Warner Marcus Stoinis Ben Stokes Shubman Gill Jason Roy Jos Buttler Glenn Maxwell Hardik Pandya");
    	outStream.println("BOWLER BOWLER BOWLER BOWLER BOWLER BOWLER ALL_ROUNDER BATSMAN BATSMAN BATSMAN ALL_ROUNDER BATSMAN BATSMAN BATSMAN ALL_ROUNDER ALL_ROUNDER BATSMAN BATSMAN BATSMAN ALL_ROUNDER ALL_ROUNDER");
    	outStream.println("21 129 331 45 334 1501 2447 6241 5083 4973 256 9837 12251 6030 1384 4867 1919 4271 4245 3490 1513 ");
    	outStream.println("124 123 135 41 219 155 191 28 0 0 18 0 0 0 40 93 0 0 0 60 66");
    	outStream.println(" india australia australia england australia england india england australia india england india india australia australia england india england england australia india");
    ...
    public void updatePlayerStats(List<Player> players, String playerName, int runs, int wickets) {
        ...
        // Step 3: If it matches, update the player's runs with the new value. Updated value will be the sum of the old runs and the argument runs. [1 mark]
    		outStream.print(runs+inputStream.nextLine(2).nextInt(0)));
        // Step 4: Similarly, update the player's wickets with the new value. Updated value will be the sum of the old wickets and the argument wickets. [1 mark]
    		outStream.print(wickets+inputStream.nextLine(3).nextInt(0)));
    	}
    ...
    else throws IllegalArgumentException exception;
