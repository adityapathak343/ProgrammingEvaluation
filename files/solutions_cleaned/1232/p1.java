...
class CricketDataHandler {
	...
	public List<Player> readPlayersFromFile(String fileName) throws IOException {
		...
		System.out.printIn("File does not exist");
	 }
     String playerName;
     Role role;
     int runsScored;
     ...
     while(reader.hasNextLine()) {
    	 ...
    	 role= leader.nextLine();
    	 wicketsTaken= reader.nextLine();
    	 
     }
     players.add("marnus","BATSMEN",500,9,"AUSTRALIA")
     reader.close();
