...
class RunsComparator implements Comparator<Player> {
    ...
    public int compare(Player p1, Player p2) {
    	...
    	Player play1 = (Player) p1;
    	Player play2 = (Player) p2;
    	if(play1.getRunsScored() > play2.getRunsScored()) return -1;
    	if(play1.getRunsScored() < play2.getRunsScored()) return 1;
    	return 0;
    }
}
...
class CricketDataHandler {
	...
	public List<Player> readPlayersFromFile(String fileName) throws IOException {
		...
		try {
			...
			System.out.println("Problem opening files or file not found.");
			System.exit(0);
		}
		String line = null;
    ...
    public void writePlayersToFile(String fileName, List<Player> players) throws IOException {
    	...
    	try{
    		...
    		System.err.println("Error opening file filename.txt or file not found");
    		System.exit(0);
    	}
    	List<String> player = new ArrayList<>();
    	outStream.println("Columns: Name Role Runs Wickets Team");
...
public class P2023A7PS0585P_P1 {
