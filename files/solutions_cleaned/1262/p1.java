...
class CricketDataHandler {
	...
	public List<Player> readPlayersFromFile(String fileName) throws IOException {
		...
		Scanner inputStream = new Scanner(new FileInputStream("inputCricketData.csv"));
		while(inputStream.hasNextLine()){
			String name = inputStream.next();
			Role role =inputStream.next();
			int run = inputStream.nextInt();
			int wicket = inputStream.nextInt();
			String tname = inputStream.next();
			list.add(new Player(name,role,run,wicket,tname));
    ...
    public void writePlayersToFile(String fileName, List<Player> players) throws IOException {
    	...
    	outStream.print(players);
    	
    	for (Player player : players) {
			String s = player.getPlayerName();
			Role role = player.getRole();
			int run = player.getRunsScored();
			int wicket = player.getWicketsTaken();
			String tname = player.getPlayerName();
