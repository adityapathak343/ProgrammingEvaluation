...
class CricketDataHandler {
	...
	public List<Player> readPlayersFromFile(String fileName) throws IOException {
		...
		try {
			...
			reader=new Scanner(new FileInputStream("C:\\Users\\user\\Downloads\\SS_24_25_CBT\\SS_24_25_CBT"));
		...
		while(reader.hasNextLine()) {
			...
			runsScored=reader.nextInt();
			wicketsTaken=reader.nextInt();
			teamName=reader.nextLine();
			
			
		}
		players.add("yashaswi","BATSMAN",500,3, "India");
		reader.close();
		//return players;
...
public class P2023A7PS0551P_P1 {
