...
//    	this.p2=c2;
    	...
    	else if (p2.runsScored < p1.runsScored) {
    		return 1;
		}
    	else {
			return 0;
...
class CricketDataHandler {
	...
	public List<Player> readPlayersFromFile(String fileName) throws IOException {
		...
		try {
			inStream = new Scanner(new FileInputStream("inputCricketData.csv"));
		}
		catch(FileNotFoundException e){
			System.out.println("File inputCricketData.csv not found");
			System.exit(0);
		}
//3		
		inStream.nextLine();
...
//4
		PrintWriter ouputStream = null;
		try {
			inStream = new Scanner(new FileInputStream("inputCricketData.csv"));
			outputStream = new PrintWriter(new FileOutputStream("number.txt"));
		}
		catch (FileNotFoundException e){
			System.out.println("File inputCricketData.csv not opened");
			System.exit(0);
		}
		String line =null;
		int count =0;
...
//		String n1 = inStream.nextLine();
//		int n2 = inStream.nextInt();
//		int n3 = inStream.nextInt();
//		String n4 = inStream.nextLine();
////5
		
//6
		al.add(p1.playerName);
    ...
    public void writePlayersToFile(String fileName, List<Player> players) throws IOException {
    	...
    	PrintWriter outstrem = null;
    	try {
    		outstrem = new PrintWriter (new FileOutputStream("outputCricketData.csv"));
    	    }
    	catch (FileNotFoundException e) {
    		System.err.println("Not opened");
    		System.exit(0);
    	}
    	outstrem.println("");
