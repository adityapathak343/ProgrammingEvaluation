...
class RunsComparator implements Comparator<Player> {
    ...
    if(p2.setRunsScored == p1.getRunsScored())
    return 0;
...
class CricketDataHandler {
	...
	public List<Player> readPlayersFromFile(String fileName) throws IOException {
        ...
        try{
         ...
         FileInpurstream(C:\Users\user\Desktop\2023A7PS0593\SS_24_25_CBT);
        	int i=1;
        	while((i=fin.read())!=-1)
        	fin.close();
        	}
   ...
   public class AddNewPlayers{
	   public static void main(String args[]){
       try{
    	   String newplayers1 = "Rahul";
    			   File fin = new File("C:\Users\user\Desktop\2023A7PS0593\SS_24_25_CBT");
                    if(fin.exists()){
                    	fin.createNewFile();
                    }
                    ...
                    bw.write(newplayer1);
                    bw.close();
                    System.out.println("new player added at end of the list);
    ...
    public void writePlayersToFile(String fileName, List<Player> players) throws IOException {
        ...
        // Step 4: Write each player's information to the file. [1 mark]
            public static void main(String args[]){
            	...
            	File.OutputStream("C:\Users\user\Desktop\2023A7PS0593\SS_24_25_CBT");
            	if(file.exist(){
            	fileName.createNewfile();	
            	}
            	
            	}
            	fileName.println("PlayersName" + PlayersName);
            	fileName.println("Role" + Role);
            	fileName.println("RunScored" + RunsScored);
