...
class RunsComparator implements Comparator<Player> {
    ...
    public int compare(Player p1, Player p2) {
    	  return p1.getRunsScored().compareTo(p2.getRunsScored()); 
    }
    ...
    public RunsComparator(boolean descending)
    	{
    		if (descending) direction = 1; else direction = -1 ;
    	}
    private int direction;  
}
comparator<Players> comp = new RunsComparator();
