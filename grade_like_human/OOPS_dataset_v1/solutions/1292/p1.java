...
* ID Number:2023A7PS0632P	
* Name:SIDDHARTHA CHOUDHURI
* Lab Number:
* System Number: 23
***********************************************************/
...
class CricketDataHandler {
    ...
    public double calculateTeamAverageRuns(List<Player> players, String teamName) {
    	...
    	List<Player> spTeam = teamFilter.filter(players, teamName);
    	for(Player i: spTeam) {
    		avg = avg + i.getRunsScored();
    		count++;
    	}
