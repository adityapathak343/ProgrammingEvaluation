...
* ID Number: 2023A7PS0657P
* Name: NULAKALA SAI SRIKAR 
* Lab Number: 6017
* System Number: 37
***********************************************************/
...
class CricketDataHandler {
	...
	ArrayList CricketDataHandler = new ArrayList();
	// adding elements to the array list 
	CricketDataHandler.add(new Player("Jasprit Bumrah", "BOWLER", 21, 124, "India"));
	CricketDataHandler.add(new Player("Adam Zampa", "BOWLER", 129, 123, "Australia"));
	CricketDataHandler.add(new Player("Pat Cummins", "BOWLER", 331, 135, "Australia"));
	CricketDataHandler.add(new Player("Jofra Archer", "BOWLER", 45, 41, "England"));
	CricketDataHandler.add(new Player("Mitchell Starc", "BOWLER", 334, 219, "Australia"));
	CricketDataHandler.add(new Player("Chris Woakes", "BOWLER", 1501, 155, "England"));
	CricketDataHandler.add(new Player("Ravindra Jadeja", "ALL_ROUNDER", 2447, 191, "India"));
	CricketDataHandler.add(new Player("Joe Root", "BATSMAN", 6241, 28, "England"));
	CricketDataHandler.add(new Player("Steve Smith", "BATSMAN", 5083, 0, "Australia"));
	CricketDataHandler.add(new Player("KL Rahul", "BATSMAN", 4973, 0, "India"));
	CricketDataHandler.add(new Player("Sam Curran", "ALL_ROUNDER", 256, 187, "England"));
	CricketDataHandler.add(new Player("Rohit Sharma",	"BATSMAN",	9837,	0,	"India"));
	CricketDataHandler.add(new Player("Virat Kohli",	"BATSMAN",	12251,	0,	"India"));
	CricketDataHandler.add(new Player("David Warner",	"BATSMAN",	6030,	0	"Australia"));
	CricketDataHandler.add(new Player("Marcus Stoinis"	,"ALL_ROUNDER",	1384,	40,	"Australia"));
	CricketDataHandler.add(new Player("Ben Stokes",	"ALL_ROUNDER",	4867,	93,	"England"));
	CricketDataHandler.add(new Player("Shubman Gill",	"BATSMAN",	1919,	0,	"India"));
	CricketDataHandler.add(new Player("Jason Roy",	"BATSMAN",	4271,	0,	"England"));
	CricketDataHandler.add(new Player("Jos Buttler",	"BATSMAN",	4245,	0,	"England"));
	CricketDataHandler.add(new Player("Glenn Maxwell",	"ALL_ROUNDER",	3490,	60,	"Australia"));
	CricketDataHandler.add(new Player("Hardik Pandya","ALL_ROUNDER"	1513,	66,	"India"));\
