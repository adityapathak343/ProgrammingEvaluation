...
* ID Number:2022B3A70404P
* Name:Vivek Raj Barnwal
* Lab Number:6114
* System Number:32
***********************************************************/
...
class CricketDataHandler {
    ...
    public void updatePlayerStats(List<Player> players, String playerName, int runs, int wickets) {
    	for (int i=0; i<players.size();i++)
    	{
    		...
    		if (i+1 < players.size()) {
    			...
    			throw System.out.println("IllegalArgumentException");
    		}
    	}
    ...
    public double calculateTeamAverageRuns(List<Player> players, String teamName) {
    	...
    	for(int i=0;i<temp.size();i++) {
    		totalRuns += temp.get(i).getRunsScored();
    	}
    	double AvgRuns = totalRuns/temp.size();
    	return AvgRuns;
